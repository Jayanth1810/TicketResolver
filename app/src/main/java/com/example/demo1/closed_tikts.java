...
public class closed_tikts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_closed_tikts);
...
//        db.setFirestoreSettings(settings);
        db.collection("tickets").whereEqualTo("status", "closed").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> queryDocumentSnapshots) {
                ...
                if (queryDocumentSnapshots.isSuccessful()) {
                    ...
                    Toast.makeText(closed_tikts.this, "nothing", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        for (int i = 0; i < n; i++) {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (doc.exists()) {
                                ...
                                progress.dismiss();
                                Toast.makeText(closed_tikts.this, "No Document", Toast.LENGTH_SHORT).show();
                            }
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                progress.dismiss();
                                Toast.makeText(closed_tikts.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
                            }
                        });
            ...
            c[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent i = new Intent(closed_tikts.this, closed_tikt_intent.class);
