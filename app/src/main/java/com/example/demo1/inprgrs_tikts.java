...
public class inprgrs_tikts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inprgrs_tikts);
        ...
        db.collection("tickets").whereEqualTo("status", status).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> queryDocumentSnapshots) {
                ...
                if (queryDocumentSnapshots.isSuccessful()) {
                    ...
                    Toast.makeText(inprgrs_tikts.this, "nothing", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        for (int i = 0; i < n; i++) {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (doc.exists()) {
                                ...
                                progress.dismiss();
                                Toast.makeText(inprgrs_tikts.this, "No Document", Toast.LENGTH_SHORT).show();
                            }
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                progress.dismiss();
                                Toast.makeText(inprgrs_tikts.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
                            }
                        });

                x:
                while(t1[i *5+j].getText().equals(null))
                    continue x;
                rl[0].addView(t[j]);
            ...
            c[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent i = new Intent(inprgrs_tikts.this, tikt_intent_inprogress.class);
